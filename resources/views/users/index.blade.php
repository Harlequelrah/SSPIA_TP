            ...
            <tbody class="text-center">
                <tr class="odd:bg-slate-200 text-sm even:bg-slate-300">
                    ...
                    <td class="px-3 py-2 flex items-center justify-center space-x-3">
                        <a href="" @click=""><i class="fa-solid cursor-pointer fa-eye text-green-800"></i></a>
                        <a href="" @click=""><i class="fa-solid cursor-pointer fa-pencil text-blue-800"></i></a>
                        <a href="" @click=""><i class="fa-solid cursor-pointer fa-trash text-red-800"></i></a>
                    </td>
                </tr>
            </tbody>
        </table>
