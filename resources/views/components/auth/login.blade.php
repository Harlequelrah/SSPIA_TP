 <div class="w-[450px]">
     <form action="">
         <div class="flex flex-col items-center justify-center">
             ...
             <x-heading-small class="text-center my-6" title="Système de Suivi des parcelles et des Interventions Agricoles" />
         </div>
         ...
         <div class="mb-4">
             ...
             <div class="flex space-x-3 items-center mt-2" x-data="{ obscuredText: true }">
                 ...
                 <i
                     :class="obscuredText ? 'fa-solid fa-eye-slash' : 'fa-solid fa-eye'"
                     class="cursor-pointer text-gray-500"
                     @click="obscuredText = !obscuredText">
                 </i>
             </div>
